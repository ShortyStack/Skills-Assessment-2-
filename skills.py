...
def get_sum_zero_pairs(input_list):
    ...
    #I had a really hard time with this. I spent a very long time
    #searching Google and trying a million things. Eventually, 
    #I asked for assistance and had it explained and put it together. I am 
    #still comfortable solving this on my own, but I do understand the logic. 
...
def encode(phrase):
    ...
    for letter in replacements:
        phrase = phrase.replace(letter, replacements[letter])
    return phrase
